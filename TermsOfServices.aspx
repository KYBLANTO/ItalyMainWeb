<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermsOfServices.aspx.cs" Inherits="ItalyMainWeb.ASPX.TermsOfServices" %>
...
<body>
    ...
    <ul>
        ...
        <li>
            <p><strong>"Terms of Service"</strong> (also referred as "Terms" or "Terms of Service") mean these Terms of Service that form the entire agreement between You and the Company regarding the use of the Service. This Terms of Service Agreement was generated by TermsFeed Terms of Service Template.</p>
        </li>
        <li>
    ...
    <p>
        These Terms of Service may have been translated if We have made them available to You on our Service.<br />
